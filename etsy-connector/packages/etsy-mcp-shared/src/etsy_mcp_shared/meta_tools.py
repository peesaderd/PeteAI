...
- Network: ``etsy_tool_index``, ``etsy_execute``, ...
...
if TYPE_CHECKING:
    from etsy_mcp_shared.lazy_tools import LazyToolLoader

logger = logging.getLogger(__name__)

# Default domain hints per prefix
_DEFAULT_DOMAIN_HINTS = {
    "etsy": "WiFi networks, clients, devices, switches, APs, firewall, VPN, routing, and statistics",
...
def register_meta_tools(
    ...
    Args:
        ...
        prefix: Tool name prefix (e.g. "etsy", "protect", "access").
        server_label: Human-readable server name for descriptions
                      (e.g. "Etsy Network", "Etsy Protect").
