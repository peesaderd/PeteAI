...
def get_protocol_version() -> str:
    ...
    Returns "v1" by default. Set ETSY_MCP_PROTOCOL_VERSION=v2 to
    switch when v2 support is added.
    """
    return os.environ.get("ETSY_MCP_PROTOCOL_VERSION", "v1").strip()
    ...
    *,
    ...
    if version == "v2":
        raise ValueError(
            ...
            "Set ETSY_MCP_PROTOCOL_VERSION=v1 or remove the variable."
        )
